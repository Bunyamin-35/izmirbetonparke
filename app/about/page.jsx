    ...
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col md:flex-row gap-16">
        ...
        <div className="md:w-1/2 lg:w-[54%] space-y-12 text-gray-700 dark:text-gray-300">
          ...
          <p>
            Balaban İnşaat adıyla ticari faaliyetini sürdürmeye 1982 yılında başlamış ve bu güne kadar büyük projelerde yüklenici tedarikçi konumlarında bulunmuştur.
            Sürdürülebilir kurumsal büyüme ile sektörde önemli bir konum edinmeyi planlayan Balaban İnşaat bu yolda hızla ilerlerken araştırma ve geliştirme çalışmalarına da ağırlık veriyor. Toplumsal konulardaki sorumluluğunu iş sorumluluğunun önemli bir parçası olarak gören Balaban İnşaat, bu alanda da hayata değer katacak çalışmalar yapmayı sürdürüyor.
          </p>
