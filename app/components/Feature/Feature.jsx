...
{
    id: 1,
    title: "Kalite Standartlarına Uygun",
    description: "Üretimlerimizi Ulusal ve uluslar arası standartlara uygun bir şekilde gerçekleştiriyoruz. ",
    icon: "task"
},
{
    id: 2,
...
},
{
    ...
    description: "Müşteri memnuniyeti için beton parke ürünlerimizi kendi araçlarımız ile müşteriye teslim ediyoruz.",
    icon: "fire"
},
]
    ...
    <section className="py-20">
        <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 space-y-16">
            <div className="space-y-4 max-w-2xl">
                ...
                <h1 className="font-bold text-gray-800 dark:text-white text-3xl">Bizi seçerek işinizi daha da ileriye taşıyın</h1>
            </div>
            <div className="mx-auto flex flex-col md:flex-row gap-10 xl:gap-14">
                ...
                <div className="md:w-1/2 md:flex-1 lg:flex xl:w-[45%]  bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-1.5 shadow-xl shadow-gray-200/50 dark:shadow-none rounded-md">
                    <div className="relative lg:w-full h-full">
                        <Image src={feature1} width={2240} height={1400} alt="system engineers celebrating successful-code-" className="absolute inset-0 rounded h-full object-cover" />
                    </div>
                </div>
            </div>
        </div>
